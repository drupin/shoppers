 ...
 */
function commerce_shoppers_form_install_configure_form_alter(&$form, $form_state) {
  // Set a default name for the dev site.
  $form['site_information']['site_name']['#default_value'] = t('Commerce shoppers');
 ...
 */
function commerce_shoppers_install_tasks() {
  $tasks = array();

  // Add a page allowing the user to indicate they'd like to install demo content.
  $tasks['commerce_shoppers_example_store_form'] = array(
 ...
 * content on install.
 */
function commerce_shoppers_example_store_form() {
 ...
 */
function commerce_shoppers_example_store_form_submit(&$form, &$form_state) {
 ...
 */
function _commerce_shoppers_create_example_catalog() {
 ...
 */
function _commerce_shoppers_create_product_image_field($entity_type, $bundle) {
 ...
 */
function _commerce_shoppers_create_product_reference($entity_type, $bundle, $field_name = 'field_product') {
